...
COPY liberty/usr/shared/config/hazelcast/*.xml /opt/ibm/wlp/usr/shared/config/hazelcast/
USER root
...
COPY liberty/usr/shared/resources/hazelcast/*.jar /opt/ibm/wlp/usr/shared/resources/hazelcast/
USER root
RUN chown 1001:0 /opt/ibm/wlp/usr/shared/resources/hazelcast/*.jar
USER 1001

#BINARIES: Add in all necessary application binaries
COPY liberty/config/server.xml /config
USER root
